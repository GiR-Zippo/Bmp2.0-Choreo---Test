using BardMusicPlayer.Choreograph.Events;
...
{
    public partial class BmpChoreograph
    {
        ...
        private ConcurrentQueue<ChoreographEvent> _eventQueue;
        ...
        {
            _eventQueue = new ConcurrentQueue<ChoreographEvent>();
        ...
        internal void PublishEvent(ChoreographEvent meastroEvent)
        {
            if (!_eventQueueOpen)
                return;
